package com.lgt.handler;

import com.lgt.annotation.ResponseResult;
import com.lgt.pojo.ErrorResult;
import com.lgt.pojo.NormalResult;
...
public class ResponseResultHandler implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter arg1, MediaType arg2,
        ...
        if (body instanceof ErrorResult) {
            ...
            return NormalResult.fail(error.getCode(), error.getMessage());
        } else if (body instanceof NormalResult) {
            return body;
        }
        return NormalResult.success(body);
    }
}